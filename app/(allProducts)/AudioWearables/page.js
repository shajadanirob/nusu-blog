...
const page = async() => {
  const res = await fetch("https://hawkers-accessories-backend.vercel.app/api/products/types/Audio&Wearables", {
    cache :'no-store'
  });
  ...
  return (
    ...
    <div className="bg-gray-300 py-2 px-4">
      <nav className="text-sm text-gray-600">
        ...
        <span className="text-gray-500">Audio Wearables</span>
      </nav>
    </div>
