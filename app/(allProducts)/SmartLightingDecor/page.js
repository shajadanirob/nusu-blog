...
const page = async() => {
  const res = await fetch("https://hawkers-accessories-backend.vercel.app/api/products/types/SmartLighting&Decor", {
    cache :'no-store'
  });
  ...
  return (
    ...
    <div className="bg-gray-300 py-2 px-4">
      <nav className="text-sm text-gray-600">
        ...
        <span className="text-gray-500">Smart Lighting & Decor</span>
      </nav>
    </div>
