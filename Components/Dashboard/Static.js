                ...
                <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-slate-100">
                    <div className="p-3 rounded-full bg-pink-600 bg-opacity-75">
                        <svg className="h-8 w-8 text-white" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path
                                d="M9.79999 8.4C9.79999 6.08041 11.6804 4.2 14 4.2C16.3196 4.2 18.2 6.08041 18.2 8.4V11.2H9.79999V8.4Z"
                                stroke="currentColor"
                                strokeWidth="2"
                                strokeLinecap="round"
                    ...
                    <div className="mx-5">
                        <h4 className="text-2xl font-semibold text-gray-700">289</h4>
                        <div className="text-gray-500">Available Products</div>
                    </div>
                </div>
            </div>

            <div className="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3">
                <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-slate-100">
            ...
            <div className="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3">
                <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-slate-100">
                    <div className="p-3 rounded-full bg-blue-600 bg-opacity-75">
                        <svg className="h-8 w-8 text-white" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M25.2 13.8H2.79999C2.0268 13.8 1.39999 14.4268 1.39999 15.2C1.39999 15.9732 2.0268 16.6 2.79999 16.6H25.2C25.9732 16.6 26.6 15.9732 26.6 15.2C26.6 14.4268 25.9732 13.8 25.2 13.8Z"
                                fill="currentColor"
                            />
                            <path
                                d="M14 1.39999C14.7732 1.39999 15.4 2.0268 15.4 2.79999V25.2C15.4 25.9732 14.7732 26.6 14 26.6C13.2268 26.6 12.6 25.9732 12.6 25.2V2.79999C12.6 2.0268 13.2268 1.39999 14 1.39999Z"
                                fill="currentColor"
                            />
                        </svg>
                    </div>
                    <div className="mx-5">
                        <h4 className="text-2xl font-semibold text-gray-700">$70,000</h4>
